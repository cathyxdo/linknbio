...
import { SocialMediaProfileClicks } from "@/shared/interfaces";

interface SocialMediaClicksProps {
    data: SocialMediaProfileClicks;
}

export default function GraphSocialMediaClicks({ data }: SocialMediaClicksProps) {
            ...
            {!showGraph ? (
                <div className="p-8 border bg-white rounded-xl hover:cursor-pointer hover:bg-stone-100" onClick={() => setShowGraph(true)}>
                    <div className="flex justify-between">
                        <div>
                            <h2 className="text-m font-bold">{data.social_media_profile_type}</h2>
                        </div>
                ...
                <div className="p-8 border bg-white rounded-xl hover:cursor-pointer"  onClick={() => setShowGraph(false)}>
                    <div className="flex justify-between mb-6">
                        <div>
                            <h2 className="text-m font-bold">{data.social_media_profile_type}</h2>
                            <p className="text-slate-500 text-sm">{data.social_media_profile_url}</p>
                        </div>
                        <div className="text-right">
