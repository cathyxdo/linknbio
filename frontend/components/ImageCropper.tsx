...
export default function ImageCropper({
  ...
  async function onUploadCropClick() {
    ...
    formData.append("file", blob, `img-${id}.png`);
    ...
    <div className="App">
      ...
      {!!completedCrop && (
        <>
          ...
          <div>
            <button onClick={onUploadCropClick} className="text-sm rounded-full bg-blue-100 hover:bg-blue-300 px-5 py-2.5 my-4">Upload Image</button>
          </div>
        </>
      )}
    </div>
